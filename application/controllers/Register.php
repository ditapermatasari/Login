...
class Register extends CI_Controller {
	...
	public function daftar()
	{
		...
		if($this->form_validation->run()==false){
			...
			$this->user->daftar();
			$this->session->set_flashdata("pesan", "<div class=\"col-md-12\"><div class=\"alert alert-success\" id=\"alert\">Username dan Password baru berhasi di tambah, Horee !!</div></div>");
			redirect('register');
		}
	}
